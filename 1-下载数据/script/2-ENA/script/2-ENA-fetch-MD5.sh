...
INPUT="/mnt/f/OneDrive/科研/4_代码/9-My-Toolskit/1-下载数据/script/2-ENA/conf/11_13.txt" #todo 每行一个样本的编号,例如：SAMEA5662571
OUTPUT="/mnt/f/OneDrive/科研/4_代码/9-My-Toolskit/1-下载数据/script/2-ENA/conf/11_13_md5.txt"
